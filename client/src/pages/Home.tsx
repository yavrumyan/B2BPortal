...
const categories = [
  ...
  "Компоненты ПК/Серверов", "Мониторы", "Принтеры/Сканеры", "Проекторы и принадлежности",
  "ИБП (UPS)", "Аксессуары", "Хранение данных (СХД)", "Программное обеспечение",
  "Сетевое оборудование", "Кабели/Переходники", "Смарт-Гаджеты",
  "ТВ/Аудио/Фото/Видео техника", "Торговое оборудование", "Системы безопасности",
];
